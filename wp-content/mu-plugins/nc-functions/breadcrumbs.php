...
/**
 * Хлебные крошки для WordPress (breadcrumbs), modified by iDeus
...
function nc_breadcrumbs( $sep = '', $l10n = array(), $args = array() ){
  $breadcrumbs = new Kama_Breadcrumbs;
...
class Kama_Breadcrumbs {
  ...
  function get_crumbs( $sep, $l10n, $args ) {
    ...
    $arg->sep = ( $arg->sep ) ? '<span class="b-breadcrumbs__sep">' . $arg->sep . '</span>' : ''; // дополним
    ...
    if ( is_front_page() ) {
      ...
      $term = $queried_object; // таксономии
