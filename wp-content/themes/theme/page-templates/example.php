  ...
  <main class="l-contentText">
    ...
    <section class="b-contentText">
      ...
      <div class="b-contentText__content b-text">
        ...
        <pre>Sed non congue ante. Duis eu augue id enim porta ultrices sed eget mi. In hac habitasse platea dictumst. Duis sodales elit id tempor faucibus. Pellentesque pellentesque varius dolor non porta. Mauris a massa venenatis, interdum purus vel, vehicula orci. Mauris vulputate massa sit amet nunc dignissim, ac vulputate ex aliquam. Integer sem felis, faucibus venenatis porttitor in, vulputate eget odio. Sed volutpat enim sed erat maximus, sed malesuada mauris interdum. In porta risus eget lacinia tristique. Donec et nisi eu eros dignissim aliquam. Donec euismod egestas dolor, id accumsan enim tempus sed. Vivamus egestas magna id condimentum porttitor.</pre>
      </div>
    </section>
