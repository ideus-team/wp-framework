...
function nc_scripts() {
  ...
  wp_enqueue_script('js-main', get_template_directory_uri().'/assets/js/scripts.js', array('modernizr', 'jquery'), filemtime(get_template_directory().'/assets/js/scripts.js'), true);
